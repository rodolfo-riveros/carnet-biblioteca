<div>
    <div class="flex items-center gap-2 mb-5">
        ...
        <span class="text-sm font-semibold text-zinc-800 dark:text-zinc-200">Importar Estudiantes</span>
    </div>
    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between p-4 bg-indigo-50 dark:bg-indigo-900/10 rounded-lg border border-indigo-200 dark:border-indigo-800">
            <div class="text-xs text-indigo-700 dark:text-indigo-300">
                ...
                <p class="text-indigo-500 dark:text-indigo-400 mt-0.5">Completa los datos de los estudiantes en el archivo Excel.</p>
            </div>
