<div class="relative overflow-hidden rounded-2xl
    ...
    <div class="relative z-10 flex items-center justify-between flex-wrap gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-white tracking-tight">Roles y Permisos</h1>
                <p class="text-sm text-zinc-400 mt-0.5">Gestiona los roles y sus permisos del sistema</p>
            </div>
        </div>
